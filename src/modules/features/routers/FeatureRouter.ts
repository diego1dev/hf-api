...
export class FeatureRouter implements IModule {
  private readonly endpoint = '/features';

  private readonly controller:FeatureController;

  constructor() {
    createDependencies();
    this.controller = GLOBAL_CONTAINER.get<FeatureController>(TYPESDEPENDENCIES.Controller);
  }
