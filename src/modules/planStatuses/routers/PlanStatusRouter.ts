...
export class PlanStatusRouter implements IModule {
  private readonly endpoint = '/planStatuses';

  private readonly controller:PlanStatusController;

  constructor() {
    createDependencies();
    this.controller = GLOBAL_CONTAINER.get<PlanStatusController>(TYPESDEPENDENCIES.Controller);
  }
...
export default PlanStatusRouter;
