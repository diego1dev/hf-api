...
export class ConsumptionRouter implements IModule {
  private readonly endpoint = '/consumptions';

  private readonly controller:ConsumptionController;

  constructor() {
    createDependencies();
    this.controller = GLOBAL_CONTAINER.get<ConsumptionController>(TYPESDEPENDENCIES.Controller);
  }
