...
import { IDeleteExample, IGetExampleByID, IUpdateExample } from '../domain/interfaces/IExample';

@injectable()
export class ExampleController {
  private useCase = GLOBAL_CONTAINER.get<ExampleUseCase>(TYPESDEPENDENCIES.UseCase);

  async create(inputData:IReqData<ExampleEntity>) {
    try {
  ...
  async getById(inputData:IReqData<IGetExampleByID>) {
    try {
  ...
  async update(inputData:IReqData<IUpdateExample>) {
    try {
  ...
  async delete(inputData:IReqData<IDeleteExample>) {
    try {
